...
//}
//
//bool scatterX(thread Ray& ray,
//             thread pbrt::SobolSampler& xsampler,
...
//
//            auto r0 = xsampler.random();
//            auto r1 = xsampler.random();
//
...
//            
//            auto fuzz = 0.01 * randomUnitInSphere(&xsampler.rng);
...
//            thread auto seed = &xsampler.rng;
//            
//            ray = Ray(hitRecord.p, randomUnitInSphere(seed));
//            scatRecord.attenuation = material.textureInfo.value(nullptr, hitRecord.uv, hitRecord.p);
//            return true;
//        }
//            
...
//            auto a2 = a1 * a1;
//            
//            if (randomF(&xsampler.rng) > pSpecular) {
//                
